...
- **Summary:** **Open summary** shows every **segment** in a main-window **table** with filters (description, duration, start/end calendar day, day range, or local date-time range).
